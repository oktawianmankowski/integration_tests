...
public class CreateUserTest extends FunctionalTests {
	...
	@Test
	public void shouldUserEmailBeUnique() {
		JSONObject uniqueEmail = new JSONObject().put("email", "jan@kowalski.com");
		JSONObject notUniqueEmail = new JSONObject().put("email", "jan@kowalski.com");
		RestAssured.given().accept(ContentType.JSON).header("Content-Type", "application/json;charset=UTF-8")
