...
public class BlogApiTest {
    ...
    @Test
    public void throwingDataIntegrityViolationExceptionShouldReturn409HTTPStatus() throws Exception {
        UserRequest user = new UserRequest();
        user.setEmail("john@domain.com");
        user.setFirstName("John");
        user.setLastName("Steward");
    ...
    @Test
    public void gettingDataForNotExistingUserShouldReturn404HTTPStatus() throws Exception {
        Long userId = 1L;
